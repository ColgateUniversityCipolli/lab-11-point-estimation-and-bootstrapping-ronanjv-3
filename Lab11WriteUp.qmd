...
p1 = ggplot(results) +
  geom_density(aes(x = Sn1pois, fill = "Sn1"), alpha = 0.5) +
  geom_density(aes(x = Snpois, fill = "Sn"), alpha = 0.5) +
  geom_vline(xintercept = 2, linetype = "dashed") +
  labs(title = "Poisson", x = "Estimate", y = "Density", fill = "Estimator")

p2 = ggplot(results) +
  geom_density(aes(x = Sn1binom, fill = "Sn1"), alpha = 0.5) +
  geom_density(aes(x = Snbinom, fill = "Sn"), alpha = 0.5) +
  geom_vline(xintercept = 2, linetype = "dashed") +
  labs(title = "Binomial", x = "Estimate", y = "Density", fill = "Estimator")

p3 = ggplot(results) +
  geom_density(aes(x = Sn1norm, fill = "Sn1"), alpha = 0.5) +
  geom_density(aes(x = Snnorm, fill = "Sn"), alpha = 0.5) +
  geom_vline(xintercept = 2, linetype = "dashed") +
  labs(title = "Normal", x = "Estimate", y = "Density", fill = "Estimator")

p4 = ggplot(results) +
  geom_density(aes(x = Sn1exp, fill = "Sn1"), alpha = 0.5) +
  geom_density(aes(x = Snexp, fill = "Sn"), alpha = 0.5) +
  geom_vline(xintercept = 2, linetype = "dashed") +
...
**Solution**
The distributions are right-skewed at small n, but become more symmetric and bell-shaped as n increases. The graphs begin looking approximately normal for large degrees of freedom. This is similar to a chi-squared distribution.
